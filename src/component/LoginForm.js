...
const LoginForm = () => {
  ...
  const formSubmitHandler = (event) => {
    ...
    axios
      .post(
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCetIgqZRXEmeSpTpeg5TOcygd-XW-h2oU",
      ...
      .then((res) => {
        if (res.status === 200) {
          ...
          dispatch(userActions.login(res.data.idToken));
          navigate("/inbox");
        }
      })
      .catch((err) => {
